package Controller.KeyControllers.Octave2;
...
public class A2 implements ActionListener {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        try {
            ...
            String fileName = "Piano.ff.A2.aiff";
            String f = new File("").getAbsolutePath().concat("\\SmartPiano_client\\src\\Model\\Assets\\Sounds\\Octave2\\" + fileName);
